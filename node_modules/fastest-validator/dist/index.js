(function (global, factory) {
	...
	var custom = function (ref, path, context) {
		...
		src.push(("\n\t\t" + (this.makeCustomValidator({ fnName: "check", path: path, schema: schema, messages: messages, context: context })) + "\n\t\treturn value;\n\t"));
	...
	var object = function (ref, path, context) {
		...
		if (subSchema) {
			...
			for (var i = 0; i < keys.length; i++) {
				...
				var innerSource = "\n\t\t\t\t" + safePropName + " = context.fn[%%INDEX%%](value, field, parentObj, errors, context);\n\t\t\t\t" + (this.makeCustomValidator({ vName: safePropName, path: newPath, schema: rule.schema, context: context, messages: messages })) + "\n\t\t\t";
